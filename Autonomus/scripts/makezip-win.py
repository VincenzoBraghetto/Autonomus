...
def main():
  ...
  vst3_bundle = build_dir + "\\Autonomus.vst3"
  ...
  if not zip:
    installer = "\\build-win\\installer\\Autonomus Installer.exe"

    if demo:
      installer = "\\build-win\\installer\\Autonomus Demo Installer.exe"

    files = [
      projectpath + installer,
      projectpath + "\\installer\\changelog.txt",
      projectpath + "\\installer\\known-issues.txt",
      projectpath + "\\build-win\\manual\\Autonomus manual.pdf"
    ]
    ...
    vst3_bundle = projectpath + "\\build-win\\Autonomus.vst3"
    if os.path.exists(vst3_bundle):
      add_folder_to_zip(zf, vst3_bundle, "Autonomus.vst3")

    # Add standalone executables
    files = [
      projectpath + "\\..\\LICENSE.txt",
      projectpath + "\\build-win\\Autonomus_x64.exe",
      projectpath + "\\build-win\\Autonomus_ARM64EC.exe",
    ]
    ...
    clap_files = [
      # Postbuild locations
      (projectpath + "\\build-win\\Autonomus_x64.clap", "Autonomus_x64.clap"),
      (projectpath + "\\build-win\\Autonomus_ARM64EC.clap", "Autonomus_ARM64EC.clap"),
      # Build output locations (fallback)
      (projectpath + "\\build-win\\clap\\x64\\Release\\Autonomus.clap", "Autonomus_x64.clap"),
      (projectpath + "\\build-win\\clap\\ARM64EC\\Release\\Autonomus.clap", "Autonomus_ARM64EC.clap"),
    ]
...
#   files = [
#     projectpath + "\\build-win\\pdbs\\Autonomus-vst3_x64.pdb",
#     projectpath + "\\build-win\\pdbs\\Autonomus-vst3_ARM64EC.pdb",
#     projectpath + "\\build-win\\pdbs\\Autonomus-app_x64.pdb",
#     projectpath + "\\build-win\\pdbs\\Autonomus-app_ARM64EC.pdb",
#     projectpath + "\\build-win\\pdbs\\Autonomus-clap_x64.pdb",
#     projectpath + "\\build-win\\pdbs\\Autonomus-clap_ARM64EC.pdb"
#   ]
