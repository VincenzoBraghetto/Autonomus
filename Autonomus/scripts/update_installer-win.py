...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Autonomus Demo Installer\n"
      else:
        line="OutputBaseFilename=Autonomus Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Autonomus Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Autonomus installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Autonomus Demo installer\n"
     else:
       line="SetupWindowTitle=Autonomus installer\n"
